...
def login():
    ...
    def maintanance():
     ...
     maint=maintenance(usernam)#loginned flat no. should be passed as the parameter
    ...
    def validate():
     ...
     if username.get() =="":
        ...
        user=Label(new,text=("Welcome!!!!",use_r),font=myFont,fg='black',borderwidth=0)        
        user.place(x=404,y=216)
        btn=Button(new,text="Details",command = display,bg='gray16',fg='white',font=('Helvetica',18))
        btn.place(
            x=435.0,
            y=337.0,
            width=216.5,
            height=61.5)
        btn1=Button(new,text="Maintainence",command = maintanance,bg='gray16',fg='white',font=('Helvetica',18))
        btn1.place(
            x=435.0,
            y=459.0,
            width=216.5,
